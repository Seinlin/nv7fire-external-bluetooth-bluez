...
int adapter_reset(struct btd_adapter *adapter)
{
...
int adapter_running(struct btd_adapter *adapter)
{
    gboolean running = TRUE;
    emit_property_changed(connection, adapter->path, ADAPTER_INTERFACE,
				"Running", DBUS_TYPE_BOOLEAN, &running);
    return 0;
}

int adapter_idle(struct btd_adapter *adapter)
{
